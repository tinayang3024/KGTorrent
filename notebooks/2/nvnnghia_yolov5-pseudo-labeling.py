...
if len(os.listdir('../input/global-wheat-detection/test/'))<11:
    ...
    get_ipython().system('python train.py --img 1024 --batch 4 --epochs 10 --data ../input/configyolo5/wheat0.yaml --cfg ../input/yolov5/v5/v5/models/yolov5x.yaml --weights ../input/yolov5/bestv4.pt')
